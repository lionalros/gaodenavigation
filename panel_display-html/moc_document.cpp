...
QT_MOC_LITERAL(4, 34, 13) // "sendTextToCpp"

    },
    "Document\0receiveTextFromWeb\0\0text\0"
    "sendTextToCpp"
};
...
void Document::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->receiveTextFromWeb((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->sendTextToCpp((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Document::receiveTextFromWeb)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Document::receiveTextFromWeb(const QString & _t1)
{
