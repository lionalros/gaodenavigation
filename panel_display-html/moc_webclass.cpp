...
QT_MOC_LITERAL(1, 9, 18), // "receiveTextFromWeb"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 3), // "lng"
QT_MOC_LITERAL(4, 33, 3), // "lat"
QT_MOC_LITERAL(5, 37, 13) // "sendTextToCpp"

    },
    "WebClass\0receiveTextFromWeb\0\0lng\0lat\0"
    "sendTextToCpp"
};
...
void WebClass::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->receiveTextFromWeb((*reinterpret_cast< float(*)>(_a[1])),(*reinterpret_cast< float(*)>(_a[2]))); break;
        case 1: _t->sendTextToCpp((*reinterpret_cast< float(*)>(_a[1])),(*reinterpret_cast< float(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (WebClass::*)(float , float );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WebClass::receiveTextFromWeb)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void WebClass::receiveTextFromWeb(float _t1, float _t2)
{
